...
Stacked Figure Template 1: Lines are Sensors, Graphs are Depths
...
Stacked Figure Template 2: Graphs are Sensors, Lines are Depths
...
season_start_date2 <- as.Date("2023-03-01")
season_end_date2 <- as.Date("2023-06-01")

filtered_data3 <- TSB_NONE_ALLDEPTHS4 %>%
...
Figure
```{r fig19, fig.height = 20, fig.width = 15}
...
ggplot(filtered_data3, aes(x = date, y = value, color = depth)) +
  ...
  theme(legend.title = element_text(size = 25),
    ...
    axis.title.y = element_text(size = 25)) +
  labs(
    title = paste("Daily average VWC for", season_start_date2, "to", season_end_date2),
    y = "Volumetric Water Content (" ~ m^3 ~ "/" ~ m^3 ~ ")",
    x = "Date",
    color = "Depth"
  ) +
