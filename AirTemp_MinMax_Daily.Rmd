...
#   c = c + 1
# }
# location = c("TNHA", "TNHA", "TNHA", "TNHA", "TNHA", "TNHA", "SSMH", "SSMH", "SSMH", "BUECI",
...
min_max = maxs_long[, c(1,3,4,2)]
min_max = data.frame(min_max, mins_long[,2])
...
avg_temp = (min_max[,4] + min_max[,5])/2
