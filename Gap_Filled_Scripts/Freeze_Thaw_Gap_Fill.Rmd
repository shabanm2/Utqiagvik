...
freeze_dates <- Daily_grndtmp_avgs %>% filter(fullname == "TNHA-BASE" & groundtemp < 0.5 & grounddepth =="65cm" & day >= "2023-06-01" & day <= "2022-12-01")
list(freeze_dates)
...
thaw_dates <- Daily_grndtmp_avgs %>% filter( fullname == "BEO" & groundtemp > -0.5 & grounddepth == "10cm" & day >= "2023-03-01" & day <= "2023-09-01") 
...
VARIATION <- SUMM24_ALLDEPTHS %>% filter( value > -1 & value < 1)
