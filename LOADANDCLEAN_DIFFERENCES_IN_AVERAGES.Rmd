...
```{r}
grndtmpwint24=read.csv(paste0(filepath, gtfile_wint24))
names(grndtmpwint24) <- sub("....C..RX3000_BRW1", "", names(grndtmpwint24))
names(grndtmpwint24) <- sub("....C..RX3000_BRW4", "", names(grndtmpwint24))
names(grndtmpwint24) <- sub("....C..RX3000_BRW5", "", names(grndtmpwint24))
names(grndtmpwint24) <- sub("....C..RX3000_BRW6", "", names(grndtmpwint24))
names(grndtmpwint24) <- sub(".RXW.GP6.", "", names(grndtmpwint24))
grndtmpwint24$Date <-as.POSIXct(grndtmpwint24$Date,format="%m/%d/%y %H:%M",tz="UTC")
```

```{r}
grndtmpspring24=read.csv(paste0(filepath, gtfile_spring24))
names(grndtmpspring24) <- sub("....C..RX3000_BRW1", "", names(grndtmpspring24))
names(grndtmpspring24) <- sub("....C..RX3000_BRW4", "", names(grndtmpspring24))
names(grndtmpspring24) <- sub("....C..RX3000_BRW5", "", names(grndtmpspring24))
names(grndtmpspring24) <- sub("....C..RX3000_BRW6", "", names(grndtmpspring24))
names(grndtmpspring24) <- sub(".RXW.GP6.", "", names(grndtmpspring24))
grndtmpspring24$Date <-as.POSIXct(grndtmpspring24$Date,format="%m/%d/%y %H:%M",tz="UTC")
```

```{r}
grndtmpsum24=read.csv(paste0(filepath, gtfile_summ24))
names(grndtmpsum24) <- sub("....C..RX3000_BRW1", "", names(grndtmpsum24))
names(grndtmpsum24) <- sub("....C..RX3000_BRW4", "", names(grndtmpsum24))
names(grndtmpsum24) <- sub("....C..RX3000_BRW5", "", names(grndtmpsum24))
names(grndtmpsum24) <- sub("....C..RX3000_BRW6", "", names(grndtmpsum24))
names(grndtmpsum24) <- sub(".RXW.GP6.", "", names(grndtmpsum24))
grndtmpsum24$Date <-as.POSIXct(grndtmpsum24$Date,format="%m/%d/%y %H:%M",tz="UTC")
```
...
summer22grndtmp$sensor <- revalue(summer22grndtmp$sensor, c('21206939'='TNHA-BASE','21393042'='BUECI-SC','21393044'='SSMH-SB','21393047'='TNHA-SC','21393048'='BEO-B05','21393049'='SSMH-SD','21398578'='BUECI-SF01','21398579'='BUECI-SE','21398583'='BUECI-SB','21398584'='BUECI-SD','21398585'='BUECI-BASE','21398588'='SSMH-BASE','21398590'='BUECI-SA','21398591'='BEO-B06','21398593'='TNHA-SA','21398598'='BUECI-SF02','21398599'='SSMH-SA','21398601'='TNHA-SD','21398576'='SSMH-BASE','21398587'='TNHA-SB'))
#note there are two "SSMH-BASE" here -- at some point we switch from -8588 to -8576, but i believe this occurs later in the data (spring 23?)
...
WINTER 23-24
```{r}
grndtmp = gather(grndtmpwint24, variable, response, Temperature.21198259.21398577.7_TNHA:Temperature.21401803.21398591.17_BEO) %>%
  mutate(variable = fct_inorder(variable))
wint24grndtmp= cSplit(grndtmp, 'variable', sep=".", direction = "wide") 
colnames(wint24grndtmp)[3] <- ("value")
colnames(wint24grndtmp)[5:7] <- c("station", "sensor", "depth")
wint24grndtmp= cSplit(wint24grndtmp, 'depth', sep="_", direction = "wide") 
colnames(wint24grndtmp)[7] <- ("depth")
wint24grndtmp$variable_1 <- NULL
wint24grndtmp$depth_2 <- NULL

wint24grndtmp$depth <- as.factor(as.character(wint24grndtmp$depth))
wint24grndtmp$sensor <- as.factor(as.character(wint24grndtmp$sensor))
wint24grndtmp$station <- as.factor(wint24grndtmp$station)
wint24grndtmp$station <- revalue(wint24grndtmp$station, c("21198259" = "TNHA", "21401800" = "BUECI", "21401801" = "SSMH", "21401803" = "BEO")) #renaming the stations
wint24grndtmp$sensor <- revalue(wint24grndtmp$sensor, c("21398585" = "BUECI-BASE", "21398590" = "BUECI-SA", "21398583" = "BUECI-SB", "21393042" = "BUECI-SC", "21398584" = "BUECI-SD", "21398579" = "BUECI-SE", "21398578" = "BUECI-SF.01", "21398598" = "BUECI-SF.02", "21398588" ="SSMH-BASE","21393049" = "SSMH-SD", "21398599" = "SSMH-SA", "21393044" = "SSMH-SB" , "21206939" = "TNHA-BASE", "21398593" = "TNHA-SA", "21398576"="TNHA-SB","21398587" = "TNHA-SB","21398601" = "TNHA-SD", "21393047" = "TNHA-SC", "21398577" = "TNHA-SE", "21393048" = "BEO-B06", "21398591" = "BEO-B05","21393045" = "BEO-B07", "21398576" = "BEO-B08",
                                                      "21393043" = "SSMH-SE",
                                                      "21398594" = "SSMH-SF",
                                                      "21398580" = "SSMH-SG",
                                                      "21398586" = "SSMH-SH",
...
wint24grndtmp$depth <- revalue(wint24grndtmp$depth, c("7" = "3.5cm", "8" = "10cm", "9" = "20cm", "10" = "30cm", "11" = "40cm", "12" = "50cm", "13" = "55cm", "14" = "65cm", "15" = "75cm", "16" = "85cm", "17" = "90cm"))

wint24grndtmp$depth = factor(wint24grndtmp$depth, c("3.5cm","10cm", "20cm", "30cm", "40cm", "50cm", "55cm", "65cm", "75cm", "85cm", "90cm"))

wint24grndtmp <- wint24grndtmp %>% filter(!value == -888.88)
...
SPRING 24
```{r}
grndtmp = gather(grndtmpspring24, variable, response, Temperature.21198259.21206939.7_TNHA:Temperature.21401803.21393048.17_BEO) %>%
  mutate(variable = fct_inorder(variable))
spring24grndtmp= cSplit(grndtmp, 'variable', sep=".", direction = "wide") 
colnames(spring24grndtmp)[3] <- ("value")
colnames(spring24grndtmp)[5:7] <- c("station", "sensor", "depth")
spring24grndtmp= cSplit(spring24grndtmp, 'depth', sep="_", direction = "wide") 
colnames(spring24grndtmp)[7] <- ("depth")
spring24grndtmp$variable_1 <- NULL
spring24grndtmp$depth_2 <- NULL

spring24grndtmp$depth <- as.factor(as.character(spring24grndtmp$depth))
spring24grndtmp$sensor <- as.factor(as.character(spring24grndtmp$sensor))
spring24grndtmp$station <- as.factor(spring24grndtmp$station)
spring24grndtmp$station <- revalue(spring24grndtmp$station, c("21198259" = "TNHA", "21401800" = "BUECI", "21401801" = "SSMH", "21401803" = "BEO")) #renaming the stations
spring24grndtmp$sensor <- revalue(spring24grndtmp$sensor, c("21398585" = "BUECI-BASE", "21398590" = "BUECI-SA", "21398583" = "BUECI-SB", "21393042" = "BUECI-SC", "21398584" = "BUECI-SD", "21398579" = "BUECI-SE", "21398578" = "BUECI-SF.01", "21398598" = "BUECI-SF.02", "21398588" ="SSMH-BASE","21393049" = "SSMH-SD", "21398599" = "SSMH-SA", "21393044" = "SSMH-SB" , "21206939" = "TNHA-BASE", "21398593" = "TNHA-SA", "21398576"="TNHA-SB","21398587" = "TNHA-SB","21398601" = "TNHA-SD", "21393047" = "TNHA-SC", "21398577" = "TNHA-SE", "21393048" = "BEO-B06", "21398591" = "BEO-B05","21393045" = "BEO-B07", "21398576" = "BEO-B08",
                                                      "21393043" = "SSMH-SE",
                                                      "21398594" = "SSMH-SF",
                                                      "21398580" = "SSMH-SG",
                                                      "21398586" = "SSMH-SH",
...
spring24grndtmp$depth <- revalue(spring24grndtmp$depth, c("7" = "3.5cm", "8" = "10cm", "9" = "20cm", "10" = "30cm", "11" = "40cm", "12" = "50cm", "13" = "55cm", "14" = "65cm", "15" = "75cm", "16" = "85cm", "17" = "90cm"))

spring24grndtmp$depth = factor(spring24grndtmp$depth, c("3.5cm","10cm", "20cm", "30cm", "40cm", "50cm", "55cm", "65cm", "75cm", "85cm", "90cm"))

spring24grndtmp <- spring24grndtmp %>% filter(!value == -888.88)
```

SUMMER 24

```{r}
grndtmp = gather(grndtmpsum24, variable, response, Temperature.21198259.21206939.7_TNHA:Temperature.21401803.21393048.17_BEO) %>%
  mutate(variable = fct_inorder(variable))
summ24grndtmp= cSplit(grndtmp, 'variable', sep=".", direction = "wide") 
colnames(summ24grndtmp)[3] <- ("value")
colnames(summ24grndtmp)[5:7] <- c("station", "sensor", "depth")
summ24grndtmp= cSplit(summ24grndtmp, 'depth', sep="_", direction = "wide") 
colnames(summ24grndtmp)[7] <- ("depth")
summ24grndtmp$variable_1 <- NULL
summ24grndtmp$depth_2 <- NULL

summ24grndtmp$depth <- as.factor(as.character(summ24grndtmp$depth))
summ24grndtmp$sensor <- as.factor(as.character(summ24grndtmp$sensor))
summ24grndtmp$station <- as.factor(summ24grndtmp$station)
summ24grndtmp$station <- revalue(summ24grndtmp$station, c("21198259" = "TNHA", "21401800" = "BUECI", "21401801" = "SSMH", "21401803" = "BEO")) #renaming the stations
summ24grndtmp$sensor <- revalue(summ24grndtmp$sensor, c("21398585" = "BUECI-BASE", "21398590" = "BUECI-SA", "21398583" = "BUECI-SB", "21393042" = "BUECI-SC", "21398584" = "BUECI-SD", "21398579" = "BUECI-SE", "21398578" = "BUECI-SF.01", "21398598" = "BUECI-SF.02", "21398588" ="SSMH-BASE","21393049" = "SSMH-SD", "21398599" = "SSMH-SA", "21393044" = "SSMH-SB" , "21206939" = "TNHA-BASE", "21398593" = "TNHA-SA", "21398576"="TNHA-SB","21398587" = "TNHA-SB","21398601" = "TNHA-SD", "21393047" = "TNHA-SC", "21393046" = "TNHA-SC2", "21398577" = "TNHA-SE", "21393048" = "BEO-B06", "21398591" = "BEO-B05","21393045" = "BEO-B07", "21398576" = "BEO-B08",
                                                      "21393043" = "SSMH-SE",
                                                      "21398594" = "SSMH-SF",
                                                      "21398580" = "SSMH-SG",
                                                      "21398586" = "SSMH-SH",
...
summ24grndtmp$depth <- revalue(summ24grndtmp$depth, c("7" = "3.5cm", "8" = "10cm", "9" = "20cm", "10" = "30cm", "11" = "40cm", "12" = "50cm", "13" = "55cm", "14" = "65cm", "15" = "75cm", "16" = "85cm", "17" = "90cm"))

summ24grndtmp$depth = factor(summ24grndtmp$depth, c("3.5cm","10cm", "20cm", "30cm", "40cm", "50cm", "55cm", "65cm", "75cm", "85cm", "90cm"))

summ24grndtmp <- summ24grndtmp %>% filter(!value == -888.88)
```



```{r}
all_hourly <- read.csv("/Users/emvanmetre/Desktop/Arctic/Gap_Filled_Data/Transposed/all_sites_hourly_gap_filled.csv")
```
...
SUMMER22_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER22_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER22_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER22_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER22_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL22_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL22_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
testdf3 <- data.frame(date,fullname,val)
BUECI_NONA <- left_join(testdf3,BUECI_DAILY, by=c("date","fullname"))
FALL22_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL22_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
testdf3 <- data.frame(date,fullname,val)
BUECI_NONA <- left_join(testdf3,BUECI_DAILY, by=c("date","fullname"))
FALL22_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SPRING23_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SPRING23_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SPRING23_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SPRING23_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SPRING23_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER23_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER23_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER23_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER23_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
SUMMER23_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL23_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL23_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL23_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL23_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
FALL23_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
...
*WINT 23-24*
-----------------------
WINT 23-24 MERGE BY STATION
-------------------
10cm
```{r}
grndmean <- wint24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "10cm") 
...
date <- rep(seq(as.Date("2023-12-01"), as.Date("2024-03-01"), by="day"),5)
val <- rep(1,length(date))
...
WINT_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
WINT_10CM$depth <- "10cm"
WINT_10CM$depth <- as.factor(WINT_10CM$depth)
```

30cm
```{r}
grndmean <- wint24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "30cm") 
...
WINT_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
WINT_30CM$depth <- "30cm"
WINT_30CM$depth <- as.factor(WINT_30CM$depth)
```

55cm
```{r}
grndmean <- wint24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "55cm") 
...
WINT_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
WINT_55CM$depth <- "55cm"
WINT_55CM$depth <- as.factor(WINT_55CM$depth)
```

65cm
```{r}
grndmean <- wint24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "65cm") 
...
WINT_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
WINT_65CM$depth <- "65cm"
WINT_65CM$depth <- as.factor(WINT_65CM$depth)
```

90cm
```{r}
grndmean <- wint24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "90cm") 
...
WINT_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
WINT_90CM$depth <- "90cm"
WINT_90CM$depth <- as.factor(WINT_90CM$depth)
```

Bind all depth dataframes together
```{r}
WINTER24_ALLDEPTHS <- rbind(WINT_10CM,WINT_30CM,WINT_55CM,WINT_65CM,WINT_90CM)
```
...
-----------
```{r}
averaged_by_site_TNHA <- WINTER24_ALLDEPTHS %>% filter(fullname == "TNHA-BASE" | fullname == "TNHA-SA" | fullname == "TNHA-SB"| fullname == "TNHA-SC" | fullname == "TNHA-SD" | fullname == "TNHA-SE") %>% aggregate(value~date+depth, mean)
averaged_by_site_TNHA$station <- c("TNHA")

averaged_by_site_BEO <- WINTER24_ALLDEPTHS %>% filter(fullname == "BEO-B06" | fullname == "BEO-B05") %>% aggregate(value~date+depth, mean)
averaged_by_site_BEO$station <- c("BEO") 

#averaged_by_site_SSMH <- WINTER24_ALLDEPTHS %>% filter(fullname == "SSMH-BASE" | fullname == "SSMH-SA" | fullname == "SSMH-SB"| fullname == "SSMH-SC" | fullname == "SSMH-SD" | fullname == "SSMH-SE" | fullname == "SSMH-SF" | fullname == "SSMH-SG" | fullname == "SSMH-SH" | fullname == "SSMH-SI") %>% aggregate(value~date+depth, mean)
#averaged_by_site_SSMH$station <- c("SSMH")

SITES_AVG_WINT24_GRND <- rbind(averaged_by_site_BEO, averaged_by_site_TNHA)
```
...
10cm
```{r}
grndmean <- spring24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "10cm") 
...
date <- rep(seq(as.Date("2024-03-01"), as.Date("2024-05-31"), by="day"),5)
val <- rep(1,length(date))
...
SPRING24_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SPRING24_10CM$depth <- "10cm"
SPRING24_10CM$depth <- as.factor(SPRING24_10CM$depth)
```

30cm
```{r}
grndmean <- spring24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "30cm") 
...
SPRING24_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SPRING24_30CM$depth <- "30cm"
SPRING24_30CM$depth <- as.factor(SPRING24_30CM$depth)
```

55cm
```{r}
grndmean <- spring24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "55cm") 
...
SPRING24_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SPRING24_55CM$depth <- "55cm"
SPRING24_55CM$depth <- as.factor(SPRING24_55CM$depth)
```

65cm
```{r}
grndmean <- spring24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "65cm") 
...
SPRING24_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SPRING24_65CM$depth <- "65cm"
SPRING24_65CM$depth <- as.factor(SPRING24_65CM$depth)
```

90cm
```{r}
grndmean <- spring24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "90cm") 
...
SPRING24_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SPRING24_90CM$depth <- "90cm"
SPRING24_90CM$depth <- as.factor(SPRING24_90CM$depth)
```

Bind all depth dataframes together
```{r}
SPRING24_ALLDEPTHS <- rbind(SPRING24_10CM,SPRING24_30CM,SPRING24_55CM,SPRING24_65CM,SPRING24_90CM)
```
...
-----------
```{r}
averaged_by_site_TNHA <- SPRING24_ALLDEPTHS %>% filter(fullname == "TNHA-BASE" | fullname == "TNHA-SA" | fullname == "TNHA-SB"| fullname == "TNHA-SC" | fullname == "TNHA-SD" | fullname == "TNHA-SE") %>% aggregate(value~date+depth, mean)
averaged_by_site_TNHA$station <- c("TNHA")

averaged_by_site_BEO <- SPRING24_ALLDEPTHS %>% filter(fullname == "BEO-B06" | fullname == "BEO-B05") %>% aggregate(value~date+depth, mean)
averaged_by_site_BEO$station <- c("BEO") 

averaged_by_site_SSMH <- SPRING24_ALLDEPTHS %>% filter(fullname == "SSMH-BASE" | fullname == "SSMH-SA" | fullname == "SSMH-SB"| fullname == "SSMH-SC" | fullname == "SSMH-SD" | fullname == "SSMH-SE" | fullname == "SSMH-SF" | fullname == "SSMH-SG" | fullname == "SSMH-SH" | fullname == "SSMH-SI") %>% aggregate(value~date+depth, mean)
averaged_by_site_SSMH$station <- c("SSMH")

SITES_AVG_SPRING24_GRND <- rbind(averaged_by_site_BEO, averaged_by_site_TNHA, averaged_by_site_SSMH)
```
...
10cm
```{r}
grndmean <- summ24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "10cm") 
...
SUMM24_10CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SUMM24_10CM$depth <- "10cm"
SUMM24_10CM$depth <- as.factor(SUMM24_10CM$depth)
```

30cm
```{r}
grndmean <- summ24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "30cm") 
...
SUMM24_30CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SUMM24_30CM$depth <- "30cm"
SUMM24_30CM$depth <- as.factor(SUMM24_30CM$depth)
```

55cm
```{r}
grndmean <- summ24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "55cm") 
...
SUMM24_55CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SUMM24_55CM$depth <- "55cm"
SUMM24_55CM$depth <- as.factor(SUMM24_55CM$depth)
```

65cm
```{r}
grndmean <- summ24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "65cm") 
...
SUMM24_65CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SUMM24_65CM$depth <- "65cm"
SUMM24_65CM$depth <- as.factor(SUMM24_65CM$depth)
```

90cm
```{r}
grndmean <- summ24grndtmp %>% subset() %>% select(value,sensor,Date,depth) %>% filter( !value == "-888.8", depth == "90cm") 
...
SUMM24_90CM <- rbind(TNHA_NONA,BEO_NONA,SSMH_NONA, BUECI_NONA)
SUMM24_90CM$depth <- "90cm"
SUMM24_90CM$depth <- as.factor(SUMM24_90CM$depth)
```

Bind all depth dataframes together
```{r}
SUMM24_ALLDEPTHS <- rbind(SUMM24_10CM,SUMM24_30CM,SUMM24_55CM,SUMM24_65CM,SUMM24_90CM)
```
...
-----------
```{r}
averaged_by_site_TNHA <- SUMM24_ALLDEPTHS %>% filter(fullname == "TNHA-BASE" | fullname == "TNHA-SA" | fullname == "TNHA-SB"| fullname == "TNHA-SC" | fullname == "TNHA-SD" | fullname == "TNHA-SE") %>% aggregate(value~date+depth, mean)
averaged_by_site_TNHA$station <- c("TNHA")

averaged_by_site_BEO <- SUMM24_ALLDEPTHS %>% filter(fullname == "BEO-B06" | fullname == "BEO-B05") %>% aggregate(value~date+depth, mean)
averaged_by_site_BEO$station <- c("BEO") 

averaged_by_site_SSMH <- SUMM24_ALLDEPTHS %>% filter(fullname == "SSMH-BASE" | fullname == "SSMH-SA" | fullname == "SSMH-SB"| fullname == "SSMH-SC" | fullname == "SSMH-SD" | fullname == "SSMH-SE" | fullname == "SSMH-SF" | fullname == "SSMH-SG" | fullname == "SSMH-SH" | fullname == "SSMH-SI") %>% aggregate(value~date+depth, mean)
averaged_by_site_SSMH$station <- c("SSMH")

SITES_AVG_SUMM24_GRND <- rbind(averaged_by_site_BEO, averaged_by_site_TNHA, averaged_by_site_SSMH)
```
