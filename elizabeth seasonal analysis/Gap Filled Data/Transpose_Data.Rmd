...
windfile <- read.csv(paste0(filepath, file))
df <- read.csv(paste0(filepath, file))
  names(df) <- sub("Solar.Radiation..S.LIB.", "", names(df))
  names(df) <- sub("...W.m.2..RX3000_BRW6", "", names(df))
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(final, paste0(exportpath, "wind", "_gap_filled_", "BEO", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(final, paste0(exportpath, "wind", "_gap_filled_", "TNHA", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(final, paste0(exportpath, "wind", "_gap_filled_", "SSMH", ".csv"))
```
