...
write.csv(df_long, paste0(exportpath, "vwc", "_gap_filled_", "BEO", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "vwc", "_gap_filled_", "TNHA", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "vwc", "_gap_filled_", "SSMH", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "temp", "_gap_filled_", "BEO", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "temp", "_gap_filled_", "TNHA", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "temp", "_gap_filled_", "SSMH", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "solar", "_gap_filled_", "BEO", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "solar", "_gap_filled_", "TNHA", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "solar", "_gap_filled_", "SSMH", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "wind", "_gap_filled_", "BEO", ".csv"))
```
...
# Call Transpose Function
final <- transpose(filepath, file)
write.csv(df_long, paste0(exportpath, "wind", "_gap_filled_", "SSMH", ".csv"))
```