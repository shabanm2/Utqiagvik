...
beo <- full_join(beo, wdir_hourly %>% ungroup() %>% select(-c(fullname, station)), by=c("Date", "site"))
```
...
colnames(tnha)[4] = "grounddepth"
tnha <- full_join(tnha, air_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
tnha <- full_join(tnha, solar_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
tnha <- full_join(tnha, wspeed_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
...
colnames(ssmh)[4] = "grounddepth"
ssmh <- full_join(ssmh, air_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
ssmh <- full_join(ssmh, solar_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
ssmh <- full_join(ssmh, wspeed_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
ssmh <- full_join(ssmh, wdir_hourly %>% ungroup(), by=c("Date", "fullname", "site", "station"))
```
