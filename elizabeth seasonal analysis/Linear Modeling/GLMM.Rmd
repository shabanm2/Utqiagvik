...
-   Binary outcome: logistic link function + probability density function for the logistic
-   Count outcome: log link function + probability mass function for the poisson
...
mixed.glmer <- lme4::glmer(groundtemp ~ airtemp + (1|station), family=gaussian(), data = tnha_nvs)
summary(mixed.glmer)
```
