...
```{r}
summer2022_lmm <- lmer(groundtemp ~ airtemp + vwc + solar + windspeed + aspect + (1|site), data = df_10cm_summer_2022)
...
```{r}
summer2022_lmm_correlated <- lmer(groundtemp ~ airtemp + vwc + solar + windspeed + aspect + (airtemp|site) + (vwc|site) + (solar|site) + (windspeed|site) + (aspect|site), data = df_10cm_summer_2022)
...
## Summer 2022 - Correlated Random Intercept and Slope Model
