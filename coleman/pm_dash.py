...
merged, temps = get_data('Utqiagvik/PM/25/fullsummer25_PM_AND_Temp_dataset.csv')
...
with col1:
    ...
    st.markdown(
        create_legend_html(
            "0", "45+",
            # WHO PM10 bins:
            # 0–15 → green, 16–30 → yellow, 31–44 → orange, 45+ → red
            "linear-gradient(to right, "
            "rgb(0,255,0) 0%, "      # Low (0–15)
            "rgb(0,255,0) 33%, "
            "rgb(255,255,0) 33%, "   # Moderate (16–30)
            "rgb(255,255,0) 66%, "
            "rgb(255,165,0) 66%, "   # High (31–44)
            "rgb(255,165,0) 85%, "
            "rgb(255,0,0) 85%, "     # Exceedance (45+)
            "rgb(255,0,0) 100%)"
        ),
    ...
    st.markdown(
        create_legend_html(
            "0", "15+",
            # WHO PM2.5 bins:
            # 0–5 → green, 6–10 → yellow, 11–14 → orange, 15+ → red
            "linear-gradient(to right, "
            "rgb(0,255,0) 0%, "      # Low (0–5)
            "rgb(0,255,0) 25%, "
            "rgb(255,255,0) 25%, "   # Moderate (6–10)
            "rgb(255,255,0) 55%, "
            "rgb(255,165,0) 55%, "   # High (11–14)
            "rgb(255,165,0) 85%, "
            "rgb(255,0,0) 85%, "     # Exceedance (15+)
            "rgb(255,0,0) 100%)"
        ),
        unsafe_allow_html=True
    )
...
with col2:
    ...
    st.markdown(
        create_legend_html(
            "0", "150+",
            # PM10 bins:
            # 0–50 → green, 51–100 → yellow, 101–149 → orange, 150+ → red
            "linear-gradient(to right, "
            "rgb(0,255,0) 0%, "        # Low (0–50)
            "rgb(0,255,0) 33%, "
            "rgb(255,255,0) 33%, "     # Moderate (51–100)
            "rgb(255,255,0) 66%, "
            "rgb(255,165,0) 66%, "     # High (101–149)
            "rgb(255,165,0) 85%, "
            "rgb(255,0,0) 85%, "       # Exceedance (150+)
            "rgb(255,0,0) 100%)"
        ),
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        create_legend_html(
            "0", "35+",
            # PM2.5 bins:
            # 0–12 → green, 13–25 → yellow, 26–34 → orange, 35+ → red
            "linear-gradient(to right, "
            "rgb(0,255,0) 0%, "        # Low (0–12)
            "rgb(0,255,0) 33%, "
            "rgb(255,255,0) 33%, "     # Moderate (13–25)
            "rgb(255,255,0) 66%, "
            "rgb(255,165,0) 66%, "     # High (26–34)
            "rgb(255,165,0) 85%, "
            "rgb(255,0,0) 85%, "       # Exceedance (35+)
            "rgb(255,0,0) 100%)"
        ),
        unsafe_allow_html=True
    )
